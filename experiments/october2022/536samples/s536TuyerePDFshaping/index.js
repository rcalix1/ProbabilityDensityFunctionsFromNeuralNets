...
async function runExample1() {
  ...
  await session.loadModel("./s536TuyerePDFshapingRC.onnx");
  ...
  <tr>
  <td> o_tuyere_t_k</td>          
  <td id="c1td1"> ${outputData.data[1].toFixed(2)} </td></tr> 
 </table>   `;
...
<tr>
<td> o_tuyere_t_k</td>
<td id="c2td1"> ${outputData.data[1].toFixed(2)} </td></tr> 
 </table>   `;
...
async function runDiff() {
 ...
 <table>
<tr><td> o_tuyere_exit_velo_m_s</td><td>${td0.toFixed(2)}</td></tr>
<tr><td> o_tuyere_t_k</td>          <td>${td1.toFixed(2)}</td></tr> 
 </table>   `;
